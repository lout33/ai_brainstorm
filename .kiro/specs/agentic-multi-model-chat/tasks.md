...
- [ ] 2. Implement Active Models Manager
  - [ ] 2.1 Create active-models.js module
  ...
  - [ ] 2.2 Build simple model management UI
...
- [ ] 3. Implement OpenRouter API Client
  - [ ] 3.1 Create openrouter-client.js module
...
- [ ] 4. Implement Conversation Manager with Two History Types
  - [ ] 4.1 Create conversation-manager.js module
...
- [ ] 5. Implement Agent Orchestrator
  - [ ] 5.1 Create agent-orchestrator.js module
  ...
  - [ ] 5.2 Build minimal agent system prompt
  ...
  - [ ] 5.3 Integrate agent with OpenRouter
...
- [ ] 6. Build Main Chat Interface (Left Panel)
  - [ ] 6.1 Create main-chat-ui.js module
  ...
  - [ ] 6.2 Implement conversation navigation
  ...
  - [ ] 6.3 Add message sending functionality
...
- [ ] 7. Build Agent Panel Interface (Right Panel)
  - [ ] 7.1 Create agent-panel-ui.js module
  ...
  - [ ] 7.2 Connect agent panel to orchestrator
...
- [ ] 8. Implement End-to-End Conversation Flow
  - [ ] 8.1 Wire create_conversations flow
  ...
  - [ ] 8.2 Wire continue_conversations (branching) flow
